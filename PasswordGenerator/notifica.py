...
class Notifica(tk.Toplevel):
    def __init__(self, titolo, esito, testo):
        ...
        self.testo = testo
        cartella = "PasswordGenerator"

        Fatto = "{}\\Immagini\\Fatto.png".format(cartella)
        Errore = "{}\Immagini\\Errore.png".format(cartella)

        FattoIco = "{}\\Immagini\\FattoIco.ico".format(cartella)
        ErroreIco = "{}\\Immagini\\ErroreIco.ico".format(cartella)
